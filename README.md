...
This is program that scrapping data from espn.com basebasll page. 
this program scraps 2017 batting data and create database.
Then, it will offer interactive searching function that 
